...
const totalArticles = async () => {
    try {
        ...
        console.log("response total article: ", response)
...
const unreviewedArticles = async () => {
    try {
        ...
        console.log("response unreviewed article: ", response)
        return response.data   
    } catch (error) {
        console.log(error)
        return error.response ? error.response.data : { error: 'An error occurred' };
...
const deletedArticles = async (token) => {
    try {
        ...
        console.log("response deleeteddd: ", response)
        return response.data   
    }
    catch (error) {
        console.log(error)
...
const modifiedArticles = async (token) => {
    try {
        ...
        console.log("response modifieddd: ", response)
        return response.data   
    }
    catch (error) {
        console.log(error)
...
const validatedArticles = async (token) => {
    try {
        ...
        console.log("response validatedl article: ", response)
        return response.data   
    }
    catch (error) {
        console.log(error)
