...
const Footer = () => {
    ...
    return (
        <footer className="flex flex-row bg-[#F3F3F3] justify-center items-start p-5 space-x-5">
            <div className='flex flex-col space-y-5 justify-start items-start p-5'>
            ...
            <div className='flex flex-col space-y-5 justify-start items-start text-start p-5'>
