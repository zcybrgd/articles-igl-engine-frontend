...
const Hero = () => {
    ...
    return (
      <div className="text-white top-8">
        ...
        <div className=" sm:left-0 w-16 sm:w-16 sm:bg-black sm:h-screen  sm:flex max-sm:h-screen md:h-screen">
          ...
          <h1 className="text-black font-semibold text-7xl  ml-0 mt-4">
            ...
            <div className=" flex  w-4/5 md:w-4/5    h-4 md:h-4  mt-16 ml-4 space-x-10 sm:w-4/5 max-sm:space-x-0 max-sm:right-0">
            ...
            <img src={quote2Icon} alt="quote2 Icon" className="hidden sm:block h-16 w-16  ml-10 mt-64 max-sm:right-0" />
             ...
             <div className=" hidden md:block md:left-4 w-16 md:w-16  bg-black h-2/5 md:h-2/5  ml-60 ">
                Animation
            </div>
